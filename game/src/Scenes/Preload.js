...
export default class Preload extends Phaser.Scene {
  ...
  importSprites() {
    ...
    this.load.spritesheet("SquaresParticles", SquaresParticles, {
      frameWidth: 32,
      frameHeight: 32,
    });
    ...
    this.load.spritesheet("SkyTiles", SkyTiles, {
      frameWidth: 128,
      frameHeight: 93,
    });
  }
  ...
  importUI() {
    ...
    this.load.spritesheet("ArrowKey", ArrowKey, {
      frameWidth: 64,
      frameHeight: 64,
    });
  ...
  create() {
    if (!GlobalConfigs.debug) this.scene.start("Start");
    else {
