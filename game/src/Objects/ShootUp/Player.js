...
export default class Player extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, x, y) {
    ...
    // Move particles
    const { hittedEmitter, moveEmitter1, moveEmitter2A, moveEmitter2B } =
      generatePlayerParticles(scene, this, x, y);
  ...
  hitted() {
    ...
    this.hittedTween.isPlaying()
      ? this.hittedTween.restart()
      : this.hittedTween.play();
  }
